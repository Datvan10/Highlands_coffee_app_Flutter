...
import 'package:highlandcoffeeapp/pages/login/admin/login_admin_page.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      onGenerateRoute: (settings){
        if(settings.name == '/add_product_page'){
      ...
      getPages: [
        ...
        GetPage(name: '/login_admin_page', page: () => const LoginAdminPage()),
